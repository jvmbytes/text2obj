...
public class Property implements Serializable {
	...
	public Object parse(String value, int lineNo) throws shutu.text2obj.exception.ParseException {
		...
		if (TYPE_STRING.equals(type))
			...
			try {
				...
				throw new shutu.text2obj.exception.ParseException(e);
			}
		}
		return value;
	}
	...
	public void validate(String val, int lineNo) throws shutu.text2obj.exception.ParseException {
		if (StringUtils.isNotBlank(pattern) && !val.matches(pattern)) {
			...
			throw new shutu.text2obj.exception.ParseException(sb.toString());
		}
	}
